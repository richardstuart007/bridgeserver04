...
const RegisterPwdHandler = require('./RegisterPwdHandler')
...
// Constants
//
const moduleName = 'RegisterPwd'
const dbKey = 'Register'
//==================================================================================
//= Register a User
//==================================================================================
async function RegisterPwd(req, res, db, logCounter) {
  let logMessage
  //
  ...
  try {
    ...
    //
    if (!user || !password) {
      rtnObj.rtnMessage = `User Password empty`
    ...
    //
    const returnData = await Promise.all([RegisterPwdHandler.RegisterPwdHandler(db, bodyParms)])
    if (debugLog)
